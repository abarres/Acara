...
<%--		<link rel="stylesheet" href="${resource(dir:'css',file:'syi4.css')}" type="text/css"/>--%>
		<link rel="stylesheet" href="${resource(dir:'css',file:'chico-0.5.9.css')}" type="text/css"/>
</head>
...
<!-- HTML2 -->
<script>
//document.title = 'Gu&iacute;a de Precios de ACARA';
</script>
<g:form>
...
<tr><td class="tit_princ" valign="top" style="padding-top:13px; padding-bottom:8px">Gu&iacute;a de Precios</td>
			...
			<td width="60%">
				<table border="0">
					...
					<tr>
						...
						<td align="left"><select style="width:250" id="version" ></select></td>
					</tr>
				</table>
			</td>
...
<-- tabla -->
<div style="padding-top: 35px; width: 526px;">
	<div style="height: 22px;" class="tit_sec"><span style="padding-left: 5px; padding-top: 7px;">Información del vehículo</span></div>
		<div class="sub_info">CBO MOTORS COMERCIALES CBO</div>
		<div style="padding-top: 10px; padding-bottom: 15px;"><table align="center" width="527">
					<tbody><tr>
				<td align="right" width="80" class="texto_negro"><b>Año:</b></td>
				<td width="420" class="texto_negro">2009</td>
			</tr>
			<tr>
				<td align="right" width="80" class="texto_negro"><b>Versión:</b></td>
				<td width="420" class="texto_negro">2 pts 1500, 1.1l, TD, TM5, HP 115.</td>
			</tr>
			<tr>
				<td align="right" width="80" class="texto_negro"><b>Kilometraje:</b></td>
				<td width="420" class="texto_negro">de 20001km/s a 25000km/s</td>
			</tr>
			<tr>
			<td height="1px" style="padding-top: 10px;" colspan="2"><div class="lin_all"></div>
			</td></tr>
				</tbody></table>
		...
		<div class="info_tit" style="width: 526px;">
		</div>
	</div>
</div>
<-- fin tabla -->
...
$('#model').change(function(){
	...
	var brandVal = $('#brand').val();
	var modelVar = $('#model').val();
	var versionValues = eval('model_'+brandVal+'_'+modelVar);
	for(var i=0; i< versionValues.length; i++){
		versionComp.append("<option value="+versionValues[i].id+">"+versionValues[i].name+"</option>");
	}
});
